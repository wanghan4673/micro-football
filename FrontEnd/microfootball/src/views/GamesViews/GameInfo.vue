<template>
    ...
    <div class="match-status">
        ...
        <a-button type="primary" v-if="statusEndNot">Follow</a-button>
...
onMounted(async ()=>{
    ...
    homeTeamLogo.value = data.jomeTeamLogo
...
.match-info {
    display: grid;
    grid-template-columns: auto 1fr auto; /* 三个列，自动调整宽度 */
    align-items: center; /* 垂直居中对齐 */
    gap: 10px; /* 列之间的间距，根据实际情况调整 */
}

.match-info img {
    width: 250px; /* 设置图片宽度，根据实际情况调整 */
    height: auto; /* 保持图片纵横比 */
}
...
.match-team {
    ...
    justify-content: space-between; /* 左右间距平分空间 */
}
...
.match-team p {
    ...
    font-weight:bolder;
    font-size:30px;
    margin: 0; /* 清除段落的默认外边距，确保它们之间没有间距 */
}
