    ...
    <div style="max-width: 200px;">
        ...
        <div class="post-button-container">
            <el-button class="post-button" @click="toNewPost" round>
                <text class="post-buttontext">点此发帖</text>
            </el-button>
        </div>
        <div class="select-tips">
            <span class="tips-text">点击下方不同联赛,查看对应主题帖...</span>
        </div>
        <el-menu class="tags-container" default-active="1">
            <el-menu-item v-for="(league, index) in leagues_logo" :key="index" :index="`${index + 1}`" @click="SelectItem(index)">
...
const leagues_logo = [
    ...
    { "logo": require('@/assets/img/lllogo.png'), "name": "西甲" },
...
const SelectItem = (index) =>{
    forumstore.sorttag = leagues_logo[index].name;
}
</script>
